...
Default input folder:
    E:\NĂM 4\Capstone\Data_input\employee_milp_inputs
Default output folder:
    E:\NĂM 4\Capstone\MILP_Model\MILP_Result

Install dependencies:
    python -m pip install pandas openpyxl pulp

Run:
    python milp_roster_model_capstone.py

Optional examples:
    python milp_roster_model_capstone.py --coverage-lower C_opt --cmax-hard
    python milp_roster_model_capstone.py --coverage-lower C_min --soft-cmax
    python milp_roster_model_capstone.py --soft-start-history
    python milp_roster_model_capstone.py --soft-coverage
"""
...
# 1. DEFAULT PATHS
# ============================================================
DEFAULT_INPUT_DIR = Path(r"E:\NĂM 4\Capstone\Data_input\employee_milp_inputs")
DEFAULT_OUTPUT_DIR = Path(r"E:\NĂM 4\Capstone\MILP_Model\MILP_Result")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--time-limit", type=int, default=300, help="CBC solver time limit in seconds.")
